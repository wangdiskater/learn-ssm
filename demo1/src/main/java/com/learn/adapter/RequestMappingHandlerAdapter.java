...
import com.learn.conversion.IntegerTypeHandler;
import com.learn.conversion.StringTypeHandler;
import com.learn.conversion.TypeHandler;
...
public class RequestMappingHandlerAdapter implements HandlerAdapter{
    ...
    private Object[] handleParameters(Method method, HttpServletRequest req) throws Exception {
        ...
        for (Parameter parameter : parameters) {
            // 获取参数名称（先埋个雷）
            //<!-- pom.xml通过反射获取方法参数时，需要设置以下参数才能保证获取到的方法参数是有意义的 -->
            //<compilerArgs>
            //	<arg>-parameters</arg>
            //</compilerArgs>
